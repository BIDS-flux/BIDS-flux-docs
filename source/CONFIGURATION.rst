...
MRI scanner configuration of a DICOM node to push the data to the Mercure server / StoreSCP. You will need the hostname, IP, port, and AEtitle of the dicom listener to configure the node in the scanner. Speak to your scanner vendor / field engineer to get the correct configuration instructions.
